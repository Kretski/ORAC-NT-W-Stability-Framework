"""
ORAC-NT v8.1 — Global Triangulation Engine
Fixes vs v8:
  1. Rolling-window SNR normalization (kills monotonic drift artifact)
  2. pk_h1 axvline now correctly uses absolute index after window search
  3. whiten() uses longer nperseg=4*FS for better PSD estimate
  4. Tukey alpha=0.25 (wider taper) to reduce edge leakage into SNR
  5. SNR clipped to merger+2s for display clarity
"""
...
# 8. STREAMLIT UI
# =========================================================
st.set_page_config(layout="wide", page_title="ORAC-NT v9")
st.title("🌍 ORAC-NT v9 | Global Triangulation Engine")
st.markdown(
    "Real LIGO/GWOSC data · **2PN Einstein chirp** · "
    "2PN SPA chirp · MAD SNR · Template-peak FFT · 3-ring triangulation · Intersection finder"
)
